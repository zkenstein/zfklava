...
return [
    ...
    'providers'       => [
        ...
        /*
         * Zfklava Framework Service Providers...
         */
        ...
        /*
         * Zfklava package Service Providers...
         */
        Zfklava\Page\Providers\PageServiceProvider::class,
        Zfklava\Message\Providers\MessageServiceProvider::class,
        Zfklava\Calendar\Providers\CalendarServiceProvider::class,
        Zfklava\Task\Providers\TaskServiceProvider::class,
        Zfklava\Settings\Providers\SettingsServiceProvider::class,
    ...
    'aliases'         => [
        ...
        'Page'             => Zfklava\Page\Facades\Page::class,
        'Settings'         => Zfklava\Settings\Facades\Settings::class,
        'Task'             => Zfklava\Task\Facades\Task::class,
        'Calendar'         => Zfklava\Calendar\Facades\Calendar::class,
        'Message'          => Zfklava\Message\Facades\Message::class,
