    <div class="head">
        <div class="overlay force-height-full">
            <nav class="navbar navbar-default navbar-static-top">
                <div class="container">
                    <a class="navbar-brand" href="{{trans_url('/')}}"><img src="{{theme_asset('img/logo/white.svg')}}" alt="Zfklava" class="img-responsive"></a>
            ...
            <div class="container">
                <div class="intro-well">
                    <div class="col-md-12">
                        ...
                        <a class="btn btn-purple btn-sm text-uppercase" href="http://www.zfklava.org/package" target="_blabk"><li class="fa fa-cubes fa-lg"></li>&nbsp;&nbsp;Packages</a>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="feature">
                        ...
                        <p>Zfklava helps you to configure your Laravel projects easily. It acts as a bootstrapper for your Laravel Content Management System.</p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="feature">
                        ...
                        <p>The online package builder helps you to build Zfklava packages easily, The downloaded package with basic required files help you to finish your projects quickly.</p>
                    </div>
                </div>
